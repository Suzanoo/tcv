...
data_collect <- function(merge_tbl, case_tbl, collated_data){
  ...
  # collated_data <- world_dailyy%>%select(-c(country, last_update))
  # i <- 1
...
#################################################################################################
##Time machine
# world_daily <- readr::read_csv("data/world_Daily.csv") %>% filter(date < '2022-03-01')
# world_weekly <- readr::read_csv("data/world_Weekly.csv") %>% filter(date < '2022-03-01')
# world_monthly <- readr::read_csv("data/world_Monthly.csv") %>% filter(date < '2022-03-01')
# 
# write.csv(world_daily, "data/world_Daily.csv", row.names = FALSE)
# write.csv(world_weekly, "data/world_Weekly.csv", row.names = FALSE)
# write.csv(world_monthly, "data/world_Monthly.csv", row.names = FALSE)
# 
# province_daily0 <- read_csv("data/province_daily.csv") %>% filter(date < '2022-03-01')
# province_weekly0 <- read_csv("data/province_weekly.csv") %>% filter(date < '2022-03-01')
# province_monthly0 <- read_csv("data/province_monthly.csv") %>% filter(date < '2022-03-01')
# thai_daily0 <- read_csv("data/thai_daily.csv") %>% filter(date < '2022-03-01')
# thai_weekly0 <- read_csv("data/thai_weekly.csv") %>% filter(date < '2022-03-01')
# thai_monthly0 <- read_csv("data/thai_monthly.csv") %>% filter(date < '2022-03-01')
# 
# write.csv(province_daily0, "data/province_daily.csv", row.names = FALSE)
# write.csv(province_weekly0, "data/province_weekly.csv", row.names = FALSE)
# write.csv(province_monthly0, "data/province_monthly.csv", row.names = FALSE)
# write.csv(thai_daily0, "data/thai_daily.csv", row.names = FALSE)
# write.csv(thai_weekly0, "data/thai_weekly.csv", row.names = FALSE)
# write.csv(thai_monthly0, "data/thai_monthly.csv", row.names = FALSE)
